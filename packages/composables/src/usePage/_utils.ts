...
import { CollectionQueryVariables, FacetInput, ProductListContentsFragment, ProductSort } from '@vue-storefront/horizon-api/lib/graphql-types';

export const convertToLocalFacetParams = (agnosticParams: AgnosticFacetSearchParams): CollectionQueryVariables => {
  ...
  return {
    handle: agnosticParams.categorySlug,
